(function (global, factory) {
  ...
  var _hoisted_1$1 = /*#__PURE__*/vue.createVNode("div", null, [/*#__PURE__*/vue.createVNode("svg", {
    fill: "none",
  ...
  var render$1 = /*#__PURE__*/_withId(function render(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    }, [_hoisted_1$1, vue.createVNode("div", _hoisted_2$1, [$options.date ? (vue.openBlock(), vue.createBlock("div", _hoisted_3, [vue.createVNode("span", _hoisted_4, vue.toDisplayString($props.locale.format($options.date, 'WWW')), 1), vue.createVNode("span", _hoisted_5, vue.toDisplayString($props.locale.format($options.date, 'MMM')), 1), vue.createVNode("span", _hoisted_6, vue.toDisplayString($props.locale.format($options.date, 'D')), 1), vue.createVNode("span", _hoisted_7, vue.toDisplayString($props.locale.format($options.date, 'YYYY')), 1)])) : vue.createCommentVNode("", true), vue.createVNode("div", _hoisted_8, [vue.createVNode(_component_time_select, {
